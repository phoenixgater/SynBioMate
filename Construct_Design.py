...
# Clear display of objects in doc
def clear_doc_display():
    if len(Main.doc) > 3:
        GUI.doc_contents_display.pack_forget()
...
# Construct assembly directory 1
def construct_assembly_directory(event):
    if part_count == 0:
        print("Please add more parts before trying to assemble")
    elif part_count == 1:
        print("Please Add more parts before trying to assemble")
    elif part_count == 2:
        construct_assembly_2()
    elif part_count == 3:
        construct_assembly_3()
    elif part_count == 4:
        construct_assembly_4()
    elif part_count == 5:
        construct_assembly_5()
    elif part_count == 6:
        construct_assembly_6()
    elif part_count == 7:
        construct_assembly_7()
    elif part_count == 8:
        construct_assembly_8()
    elif part_count == 9:
        construct_assembly_9()
    elif part_count == 10:
        construct_assembly_10()

# Construct assembly directory 2
def construct_assembly_2():
    construct_name = GUI.construct_name_entry.get()
    assembled_construct = ComponentDefinition(str(construct_name))
    Main.doc.addComponentDefinition(assembled_construct)
    ...
    if part_2_components == 0:
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd])
        assembled_construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2b_cd, part2a_cd])
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)


def construct_assembly_3():
    construct_name = GUI.construct_name_entry.get()
    assembled_construct = ComponentDefinition(str(construct_name))
    Main.doc.addComponentDefinition(assembled_construct)
    part1_cd = Main.doc.getComponentDefinition(str(part1))
    ...
    if part_3_components == 0:
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd])
        assembled.construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3b_cd, part3a_cd])
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)


def construct_assembly_4():
    construct_name = GUI.construct_name_entry.get()
    assembled_construct = ComponentDefinition(str(construct_name))
    Main.doc.addComponentDefinition(assembled_construct)
    part1_cd = Main.doc.getComponentDefinition(str(part1))
    ...
    if part_4_components == 0:
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4_cd])
        assembled_construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4b_cd, part4a_cd])
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)


def construct_assembly_5():
    construct_name = GUI.construct_name_entry.get()
    assembled_construct = ComponentDefinition(str(construct_name))
    Main.doc.addComponentDefinition(assembled_construct)
    part1_cd = Main.doc.getComponentDefinition(str(part1))
    ...
    if part_5_components == 0:
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4_cd, part5_cd])
        assembled.construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4_cd, part5b_cd, part5a_cd])
        assembled.construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")



def construct_assembly_6():
    construct_name = GUI.construct_name_entry.get()
    assembled_construct = ComponentDefinition(str(construct_name))
    Main.doc.addComponentDefinition(assembled_construct)
    part1_cd = Main.doc.getComponentDefinition(str(part1))
    ...
    if part_6_components == 0:
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4_cd, part5_cd, part6_cd])
        assembled.construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
        ...
        assembled_construct.assemblePrimaryStructure([part1_cd, part2_cd, part3_cd, part4_cd, part5_cd, part6b_cd,
                                                      part6a_cd])
        assembled.construct.compile()
        result = Main.doc.write((str(construct_name)) + ".xml")
        print(result)
